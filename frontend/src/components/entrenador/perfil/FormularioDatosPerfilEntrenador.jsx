  ...
  return (
    <div className="w-full max-w-2xl bg-slate-900 rounded-2xl border border-slate-800 shadow-2xl p-6 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <SeccionDatosBasicosPerfil form={form} trainerCode={codigoEntrenador} inputClass={inputClass} labelClass={labelClass} onChange={onChange} />
        <SeccionServiciosPerfil form={form} onChange={onChange} />
        <SeccionFiscalBancariaPerfil form={form} inputClass={inputClass} labelClass={labelClass} onChange={onChange} />
