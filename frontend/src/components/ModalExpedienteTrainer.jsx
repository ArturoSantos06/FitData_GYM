      ...
      <div className="bg-[#1e293b] w-full max-w-6xl rounded-[2.5rem] border border-slate-700 flex flex-col md:flex-row h-[90vh] overflow-hidden shadow-2xl relative">
        ...
        <div className="w-full md:w-80 p-8 bg-[#111827] border-r border-slate-800/50 flex flex-col">
          <div className="flex justify-between items-center mb-8">
            <h2 className="font-black text-2xl tracking-tighter italic text-white uppercase">WORK<span className="text-orange-400">OUT</span></h2>
          ...
          <div className="flex flex-col items-center text-center mb-8 p-6 bg-slate-900/50 rounded-[2rem] border border-slate-800 shadow-inner">
             ...
             <div className="text-lg font-black text-white uppercase leading-tight">
                {miembro.nombre} <br/>
                <span className="text-orange-400 text-sm font-bold opacity-80">{miembro.apellido}</span>
             </div>
          ...
          <div className="flex-1 flex flex-col space-y-3">
             <label className="text-[10px] font-black text-orange-500 uppercase tracking-[0.2em] flex items-center gap-2 ml-1">
             ...
             <textarea 
                ...
                className="w-full flex-1 bg-[#0f172a] border border-slate-800 rounded-3xl p-5 text-slate-200 text-sm outline-none focus:border-orange-500/50 transition-all resize-none shadow-inner font-medium"
             />
          </div>
        </div>
        ...
        <div className="flex-1 p-8 bg-[#0f172a] overflow-y-auto">
          <style>{`
            ...
            .fc-daygrid-day:hover { background-color: rgba(249, 115, 22, 0.1) !important; cursor: pointer;}
