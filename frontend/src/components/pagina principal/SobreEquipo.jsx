...
function AboutTeam() {
  ...
  const teamMembers = [
    ...
    { name: 'Wiliam Escamilla', role: 'Full Stack Developer', avatar: 'WE' }
  ];
                    ...
                    {member.image ? (
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          e.currentTarget.parentElement.innerHTML = `<div class="w-full h-full bg-linear-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-3xl font-bold text-white">${member.avatar}</div>`;
                        }}
                      />
                    ) : (
                      <div className="w-full h-full bg-linear-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-3xl font-bold text-white">
                        {member.avatar}
                      </div>
                    )}
                  </div>
