...
function ClientStore() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-950/70">
        <div
          className="flex transition-transform duration-500 ease-in-out"
          style={{
            width: '300%',
            transform: activeSection === 'productos'
              ? 'translateX(0%)'
        ...
        >
          ...
          <div className="w-full shrink-0 p-6 border-l border-slate-800">
            <div className="bg-slate-900/60 border border-slate-800 rounded-3xl space-y-4">
              ...
              <div className="max-h-[520px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700 divide-y divide-slate-800">
                ...
                {sales.flatMap((s, i) => {
                  ...
                  return items.map((it, idx) => (
                    <div key={`${i}-${idx}`} className="px-6 py-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
